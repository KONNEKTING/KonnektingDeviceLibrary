...
const byte KnxDptFormatToLength[] PROGMEM = {
  ...
  24, //  KNX_DPT_FORMAT_N3N5R2N6R2N6,
  24, //  KNX_DPT_FORMAT_R3N5R4N4R1U7,
...
const byte KnxDptToFormat[] PROGMEM = {
  ...
  KNX_DPT_FORMAT_B1R1U6,//  KNX_DPT_18_001, // 18.001 B1r1U6 DPT_SceneControl
