...
void KnxComObject::Info(String& str) const {
    ...
    str += "\nPrio=";
    switch (GetPriority()) {
        case KNX_PRIORITY_SYSTEM_VALUE: str += "SYSTEM";
            break;
        case KNX_PRIORITY_ALARM_VALUE: str += "ALARM";
            break;
        case KNX_PRIORITY_HIGH_VALUE: str += "HIGH";
            break;
        case KNX_PRIORITY_NORMAL_VALUE: str += "NORMAL";
            break;
        default: str += "ERR_VAL!";
            break;
    }
    str += "\nValidity=";
    if (GetValidity()) str += "YES";
    else str += "NO";
