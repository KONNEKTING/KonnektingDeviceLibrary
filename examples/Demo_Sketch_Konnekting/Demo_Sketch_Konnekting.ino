#include <KnxDevice.h>
#include "KONNEKTING_deviceconfiguration_Test_Sketch.h" //generated with KONNEKTING CodeGenerator
...
// ################################################
// see KONNEKTING_deviceconfiguration_Test_Sketch.h
...
void setup() {
     ...
     * If no pointer are required, please remove all three Konnekting.setEeprom* lines below
     */
...
void knxEvents(byte index) {
    ...
    switch (index) {
        ...
        case COMOBJ_commObj1: // object index 0 has been updated
